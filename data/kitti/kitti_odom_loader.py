...
class kitti_odom_loader(object):
    ...
    def collect_test_frames(self):
        ...
        for seq in self.test_seqs:
            ...
            img_dir = os.path.join(seq_dir, 'image_3')       #left images
    ...
    def load_image(self, drive, frame_id):
        img_file = os.path.join(self.dataset_dir, 'sequences', '%s/image_3/%s.png' % (drive, frame_id)) #left images
    ...
    def read_calib_file(self, filepath, cid=3):                            #image_3
