...
class kitti_raw_loader(object):
    def __init__(self,
        ...
        test_scene_file = dir_path + '/test_scenes_' + split + '.txt'  #all the test files' sequence name
        ...
        self.cam_ids = ['03']   #self.cam_ids = ['02', '03']
    ...
    def load_intrinsics_raw(self, drive, cid, frame_id):
        ...
        intrinsics = P_rect   #[:3, :4]   #  intrinsics = P_rect[:3, :3]
        return intrinsics
